defmodule TasktrackerSpaWeb.TaskControllerTest do
  ...
  @create_attrs %{descrip: "some descrip", title: "some title"}
  @update_attrs %{descrip: "some updated descrip", title: "some updated title"}
  @invalid_attrs %{descrip: nil, title: nil}
